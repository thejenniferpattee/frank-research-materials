...
## Status
IRB approved. Preparing for data collection.

## Primary Research Question
Are students willing to use an AI-mediated screening and psychoeducation experience for attention-related concerns, and what predicts willingness?

## Secondary Questions
- What drives or reduces trust, perceived safety, and comfort with disclosure?
- What design elements are most likely to increase consent comprehension and reduce friction?
- What concerns students have about privacy, misuse, and harm.
...
## Exclusion Criteria
Under 18, Anyone who does not provide consent.

## Procedure
- Participants open the link.
- Read a plain language consent page.
- View the Frank concept and example flow.
- Complete measures about willingness, trust, perceived safety, and concerns.
- Receive debrief and support resources.

## Primary Outcomes
- Willingness to try Frank.
- Acceptability of Frank.
- Trust and perceived safety.
- Intent to seek help or learn more after using a tool like this.
...
- Minimize sensitive data collection. Ask only what is needed to answer the research questions.
- Provide support resources and a debrief that normalizes help-seeking.
...
## Deliverables
- Phase 1 protocol and consent packet.
- Measures registry entry with provenance and scoring.
...
- Results inform design direction and ethics constraints, not clinical validity.
